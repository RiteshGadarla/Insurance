...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed top-0 left-0 h-screen w-64 flex flex-col p-4 shadow-lg border-r bg-gradient-to-b z-40 transition-all duration-300",
          theme.border,
          theme.bg,
                ...
                <div className="flex items-center gap-3">
                  <Icon
                    className={cn(
                      ...
                      isActive
                        ? "text-white"
                        : cn("text-slate-500", theme.iconHover)
                    )}
                  />
                  {link.label}
                </div>
